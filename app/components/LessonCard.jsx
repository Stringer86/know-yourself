...
export default class LessonCard extends React.Component {
  constructor(props) {
    ...
    this.state = {
      favorited: fav,
      favoriteCount: this.props.data.likes
    }
  }
  ...
  favorite(event) {
    ...
    .then(() => {
      const nextFavoriteCount = this.state.favoriteCount + 1;
      this.setState({ favoriteCount: nextFavoriteCount });

      axios.patch(`/api/lessons/${this.props.id}`, {
        likes: nextFavoriteCount
      })
      .then(() => {
