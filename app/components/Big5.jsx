    ...
    return (
      ...
      <div className="row big5">
        ...
        <div className="col s12 m6 l6 center-align">
          <img id="openness" src="http://4.bp.blogspot.com/-M1H0FoqnAGI/UACZW3mewTI/AAAAAAAAA04/GKjRZxaF2vQ/s1600/O+socorro+de+Deus.jpg" height="100%" width="100%"></img>
        </div>
        </div>
        <Reveal effect="animated fadeIn">
        <div className="row big5">
        <div className="col s12 m6 l6">
          <img id="conscientiousness" src="http://img.best-crowdfunding-websites.com/2016/05/planning-your-crowdfunding-campaign-brainstorming.jpg" height="100%" width="100%"></img>
        </div>
          <div className="col s12 m6 l6">
          ...
          <div className="row big5">
            ...
            <div className="col s12 m6 l6 center-align">
              <img id="extraversion" src="http://psychology.iresearchnet.com/wp-content/uploads/2016/01/Extraversion.jpg" height="100%" width="100%"></img>
            </div>
            </div>
            </Reveal>
            <Reveal effect="animated fadeIn">
            <div className="row big5">
            <div className="col s12 m6 l6">
              <img id="agreeableness" src="http://i1.wp.com/1.bp.blogspot.com/-zQco0Ut-pWs/T85HhQGMl2I/AAAAAAAAAus/6CZCh6Mv1dA/s1600/officeWorkersHighFive.jpg" height="100%" width="100%"></img>
            </div>
              <div className="col s12 m6 l6">
              ...
              <div className="row">
                ...
                <div className="col s12 m6 l6 center-align">
                  <img id="neuroticism" src="https://www.papermasters.com/images/neurotic-anxiety.jpg" height="100%" width="100%"></img>
                </div>
                </div>
                </Reveal>
        </div>
